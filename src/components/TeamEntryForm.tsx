                    ...
                    {formData.team_id && !requiresEventSelection && (
                        <div>
                            ...
                            <Select
                                ...
                                onValueChange={(value) =>
                                    setFormData((prev) => ({ ...prev, member_type: value as 'Team Member' | 'Lead' }))
                                }
                            >
                                <SelectTrigger className="bg-[#0a0a0f] border-white/10 text-white">
                                ...
                                <SelectContent className="bg-[#0a0a0f] border-white/10">
                                    <SelectItem value="Team Member" className="text-white focus:bg-white/10 focus:text-white">
                                        Team Member
                                    </SelectItem>
                                    <SelectItem value="Lead" className="text-white focus:bg-white/10 focus:text-white">
                                        Lead
                                    </SelectItem>
                                </SelectContent>
                            </Select>
