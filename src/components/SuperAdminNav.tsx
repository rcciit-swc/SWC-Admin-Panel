...
export default function SuperAdminNav() {
    ...
    if (pathname !== '/landing' && !pathname.startsWith('/admin')) {
        return null;
    }
        ...
        <div className="w-full bg-[#0a0a0f]/50 backdrop-blur-md border-b border-white/[0.06] relative md:sticky top-[60px] md:top-[80px] z-40">
            <div className="container max-w-7xl mx-auto px-4 sm:px-6 py-3">
                <div className="flex flex-wrap items-center gap-2 sm:gap-3 w-full">
                    <Link href={festId ? `/admin/${festId}/approve` : "/select-fest?redirect=approve"} className="w-full sm:w-auto">
                    ...
                    <Link href={festId ? `/admin/${festId}/manage-sequences` : "/select-fest?redirect=manage-sequences"} className="w-full sm:w-auto">
