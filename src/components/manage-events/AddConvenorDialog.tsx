...
import { Convenor } from '@/lib/types/events';
import { Plus, Users } from 'lucide-react';
import { useState } from 'react';

interface AddConvenorDialogProps {
  addConvenor: (convenor: Convenor) => void;
}

export function AddConvenorDialog({ addConvenor }: AddConvenorDialogProps) {
        ...
        <div className="space-y-4 py-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="Enter convenor name"
